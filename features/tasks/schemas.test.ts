...
const base = { title: "Finish reading", description: "", status: "todo", priority: "medium", dueKind: "none", dueDate: "", dueLocal: "", estimatedEffortMinutes: "", assessmentId: "", goalId: "" };
...
describe("Task validation", () => {
  ...
  it("rejects malformed dates, effort, relationship IDs, and workflow states", () => {
    ...
    expect(taskSchema.safeParse({ ...base, goalId: "another-user" }).success).toBe(false);
